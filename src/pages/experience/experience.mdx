...
During my time at Costco, I primarily used Python, OracleDB, Tableau, and Alteryx to develop tools for different departments within the company. Rather than just listing my responsibilities, I want to highlight some of my achievements:
...
- Major Project 2: Implemented Apriori data mining algorithm in Python to perform market basket analysis on 2+ years of transactional data from Oracle SQL database. Created interactive Tableau report using this data for departments and digital marketing team at Costco E-commerce, enabling them to identify optimal item bundles.
...
- Developed Tableau dashboards for shipping discrepancy research
...
I also got to build on my understanding of Python as well as having my first massive scale interaction with relational databases and SQL. 
